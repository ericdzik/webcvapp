...
export default function ExecutiveTemplate({ data }: { data: ResumeData }) {
  ...
  const styles = StyleSheet.create({
    page: { fontFamily: "Helvetica", fontSize: f(10), color: "#1a1a2e" },
    ...
    name: { fontSize: f(24), fontFamily: "Helvetica-Bold", letterSpacing: 2, color: "#fff", marginBottom: 3 },
    title: { fontSize: f(11), color: "#a8b4c8", letterSpacing: 1, marginBottom: s(10) },
    contactRow: { flexDirection: "row", gap: 12, flexWrap: "wrap" },
    contactItem: { fontSize: f(9), color: "#c8d4e8" },
    dividerGold: { height: 2, backgroundColor: "#c9a84c", width: 60, marginTop: s(10) },
    body: { padding: "20 40" },
    section: { marginBottom: s(14) },
    sectionHeader: { flexDirection: "row", alignItems: "center", marginBottom: s(7) },
    sectionTitle: { fontSize: f(10), fontFamily: "Helvetica-Bold", color: "#1a1a2e", textTransform: "uppercase", letterSpacing: 2 },
    ...
    company: { fontSize: f(9), color: "#c9a84c", fontFamily: "Helvetica-Bold", marginBottom: 2 },
    date: { fontSize: f(9), color: "#888", fontFamily: "Helvetica-Oblique" },
    description: { fontSize: f(9), color: "#444", lineHeight: 1.4, marginTop: 2 },
    entryWrap: { marginBottom: s(9) },
    twoCol: { flexDirection: "row", gap: 24 },
    col: { flex: 1 },
    skillTag: { backgroundColor: "#f0ece0", borderLeft: "3px solid #c9a84c", paddingHorizontal: 6, paddingVertical: s(3), marginBottom: s(4), fontSize: f(9) },
    skillRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
    skillLevel: { fontSize: f(8), color: "#c9a84c", fontFamily: "Helvetica-Bold" },
    langRow: { flexDirection: "row", justifyContent: "space-between", marginBottom: s(4), fontSize: f(9) },
    langLevel: { color: "#c9a84c", fontFamily: "Helvetica-Bold", fontSize: f(9) },
  });
